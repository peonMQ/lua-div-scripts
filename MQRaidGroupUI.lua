...
-- Target and Raid UI for pulling and healing 
-- Window fade 
...
-- -- /lua run examples/RaidSample
-- local mq = require 'mq'
-- -- AutoComplete lua guides 
-- require 'ImGui'
-- require 'mq'
...
--         --PlaceButtonSimple("Stay", 42, 20, "/g Stay")

--         PlaceButton('Stay', 42, 20, function() CmdCallBack('/g stay') end)
...
--             local function mqtlo(tloname, member, nilreturn)
--                 local retval = mq.TLO[tloname][member]()
--                 if retval == nil then
--                     return nilreturn
--                 else
--                     return retval
...
--         local RaidNumber = mqtlo("Raid", "Members", 0)
--         if RaidNumber == 0 then
--             -- If you want to see your bar without grouppPut the code here 
--         else
--             for i=1,RaidNumber do
--                 -- Get pctHP and Mana
--                 local boolNetBots = mq.TLO.NetBots() or false
--                 if not boolNetBots then break end
...
--                 if Casting or Attacking then
--                     ImGui.TextColored(1, 0, 0, 1,'\xee\x9f\xbd')
--                 else
...
--                 if isnetbots(raidname, "Moving", false) then 
--                     ImGui.TextColored(1, 0, 0, 1,'\xee\x95\xa6') 
--                 else
...
-- mq.imgui.init('RaidSample', RaidSample)

-- --Thanks dannuic for forcing me into the light 
...
-- function PlaceButtonSimple(Name, PosX, PosY, MQCommand)
--     if ImGui.Button(Name, PosX, PosY) then mq.cmd(MQCommand) end
-- end

-- function PlaceButton(Name, PosX, PosY, MQCommand)
--     if ImGui.Button(Name, PosX, PosY) then MQCommand() end
-- end
